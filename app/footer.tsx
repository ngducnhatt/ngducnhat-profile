...
export function Footer() {
    ...
    const containerClass = isDashboard ? 'max-w-6xl px-6 sm:px-10' : 'max-w-3xl px-4'

    return (
        <div className={`mx-auto w-full ${containerClass} pb-6 pt-8`}>
            <footer className="border-t border-zinc-100 px-0 py-2 dark:border-zinc-800">
